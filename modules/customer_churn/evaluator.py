...
class ChurnEvaluator:
    ...
    def save_report(self, best: Dict, feature_count: int, n_test: int, n_churners: int, monthly_revenue_at_risk: float):
        report = {
            ...
            "n_test": int(n_test),
            "n_test_churners": int(n_churners),
            "feature_count": int(feature_count),
            "monthly_revenue_at_risk": float(monthly_revenue_at_risk)
        }
